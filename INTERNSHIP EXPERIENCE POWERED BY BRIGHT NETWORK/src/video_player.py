...
class VideoPlayer:
    ...
    def __init__(self): 
        self._video_library = VideoLibrary() ### It contains information regarding all the videos.
        self.video_under_process = video_under_process() ### It currently playing the videos.
    ...
    def play_video(self, video_id):
        ...
        if video != None:
            ...
            if(video.flagged == None):
                if self.video_under_process.status != video_state.Stop: ### Avoiding the first time error print message from the stop_video.
                    self.stop_video() ### Stops the current video if is playing.
    ...
    def play_random_video(self):
        ...
        ###When all the videos are marked as flagged  showing that no video availiable for random function.
    ...
    def create_playlist(self, playlist_name):
        ...
        if pln in self.playlists.keys():
            ...
            self.playlists[ pln ] = []
            self.userWrittenStylePlaylists[pln] = playlist_name ###Used for  user to display the playlists.
    ...
    def show_all_playlists(self):
        ...
        if(len(self.playlists.keys()) == 0): ###It means that no playlist was added.
    ...
    def flag_video(self, video_id, flag_reason=""):
        ...
        ### If there is no reason provided
        if(flag_reason == ""):
        ...
        if video != None:
            if(video.flagged == None):
                ...
                ### If it is the same video that is playing then stop it alone.
                if(self.video_under_process.video != None):
